...
export default function LookupDeleteModal({
  open,
  activeTab,
  onConfirm,
  onCancel,
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm p-4 animate-in fade-in duration-300">
      <div className="w-full max-w-md bg-white rounded-3xl p-6 shadow-xl border border-neutral-200">
        <h3 className="font-serif text-xl font-bold text-neutral-800 mb-2">
          Delete master {activeTab}?
        </h3>
        <p className="text-xs text-neutral-500 mb-6 font-medium leading-relaxed">
          Are you sure you want to delete this option? Products referencing this master lookup parameter may lose their connection. This action cannot be undone.
        </p>
